...
PayOff* PayOffFactory::CreatePayOff(string PayOffId, double Strike)
{
    ...
    // Second actually is the Create function of PayOffHelper class. 
    // This function will return a pointer to PayOff base class which is returned in this function.
