...
// Real random generator ParkMiller has different interface, so just write another outer class RandomParkMiller
// to encapsulate it to make the same interface.
